    ...
    <div>
      <div className='s4-container'>
        <div className='s4-header'>
          <p className='s4-text'>Our Work</p>
          <h1 className='s4-head'>Featured Projects</h1>
          <p className='s4-text'>Explore our diverse portfolio showcasing stunning book covers and illustrations that bring stories to life.</p>
        </div>
